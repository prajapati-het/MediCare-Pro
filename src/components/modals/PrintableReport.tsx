...
export default function PrintableReport({selectedSections }: Props) {
    ...
    const hospitalName = useSelector((state: RootState) => state.app.user.hospital);
  ...
  return (
    <>
      ...
      <div className="print-container bg-white rounded-lg border p-8 shadow-sm">
        {/* Hospital Header */}
            ...
            <div className="space-y-4">
              ...
              <div
                className={`p-4 rounded-lg ${
                  patient.allergies.length ? "bg-red-50" : "bg-green-50"
                }`}
              >
                <p className="text-sm text-gray-600 mb-1">Allergies</p>
                <p
                  className={`font-semibold ${
                    patient.allergies.length ? "text-red-700" : "text-green-700"
                  }`}
                >
              ...
              {patient.prescriptions.map((rx, idx) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-center text-sm text-gray-500 mt-2 pt-2 border-t border-gray-200">
                    <span>
                      Duration: {rx.startDate} → {rx.endDate}
                    </span>
          ...
          <section className="mb-8 page-break-inside-avoid">
            ...
            <div className="space-y-4">
              {patient.visitHistory.map((visit, idx) => (
                <div
                  key={idx}
                  className="relative pl-8 pb-4 border-l-2 border-primary last:border-0"
                >
